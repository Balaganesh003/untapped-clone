  ...
  const getHighlightedText = (text, highlight) => {
    ...
    return parts.map((part, index) =>
      part.toLowerCase() === highlight.toLowerCase() ? (
        <strong key={index} className="text-primary-text font-semibold">
          {part}
        </strong>
      ) : (
        part
        ...
        <div className="relative">
          ...
          {isOpen && (
            <div className="rounded-lg overflow-hidden">
              <ul
                ref={dropdownRef}
                className="absolute bg-white border py-[3px] border-light-gray rounded w-full max-h-[12.25rem] z-[10] overflow-y-auto">
