...
import CompanyLogo from '@/assets/degreedLogo.png';
import SaveOutlineButton from '@/components/SaveOutlineButton';

const JobsCard = () => {
  return (
    <div className="w-full  bg-white p-[0.9375rem] rounded border border-gray-border hover:shadow-card text-primary-text justify-stretch cursor-pointer group overflow-hidden">
      {/* Logo and applicants */}
      ...
      <div>
        <p className="text-[1rem] mb-2 leading-[1.375rem] font-medium text-primary-text">
          Senior Software Engineer - Front end - Bengaluru
        </p>
        ...
        <div className="mb-3 text-ellipsis text-[0.75rem] leading-[1rem] text-primary-text">
          <span className="captilize">Full Time</span>
          <span className="mx-[3px]">•</span>
          <span className="captilize">Bengaluru, Ka, Remote</span>
        </div>
      </div>
